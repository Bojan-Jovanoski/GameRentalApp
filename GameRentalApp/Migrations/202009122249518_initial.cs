    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SonyID = c.Int(nullable: false, identity: true),
                        AvailableCopies = c.Int(nullable: false),
                        GameName = c.String(),
                        Genre = c.Int(nullable: false),
                        ImgUrl = c.String(),
                ...
                .PrimaryKey(t => t.SonyID);
            
            CreateTable(
                "dbo.SwitchGames",
                c => new
                    {
                        SwitchID = c.Int(nullable: false, identity: true),
                        AvailableCopies = c.Int(nullable: false),
                        GameName = c.String(),
                        Genre = c.Int(nullable: false),
                        ImgUrl = c.String(),
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.SwitchGames");
            DropTable("dbo.SonyGames");
